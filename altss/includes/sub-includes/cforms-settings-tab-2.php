<?php
        if (current_user_can('manage_options')) {
            ...
            foreach ($FORM_FIELDS as $key => $val) {
                $fieldsSettings = get_option("s_settings_cforms_options_field_{$key}");
                ?>
                    <div class="cf-fields-item">
                        <dl>
                            ...
                            <dd>
                                ...
                                <input type="text" name="s_settings_cforms_options_field_<?php echo esc_attr( $key );?>[label]"
                            ...
                            <dd>
                                ...
                                <input type="text" name="s_settings_cforms_options_field_<?php echo esc_attr( $key );?>[placeholder]"
