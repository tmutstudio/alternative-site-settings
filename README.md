...
![New onboarding wizard to help you get started.](.wordpress-org/screenshot-14.png)


### Frontend -> REVIES Page (TAMA WP Theme).
![New onboarding wizard to help you get started.](.wordpress-org/screenshot-15.png)


### ASS Plugin Contact Forms Settings Page -> tab "Additional settings".
![New onboarding wizard to help you get started.](.wordpress-org/screenshot-16.png)


### Admin Panel -> ASS Plugin site settings start page -> tab "Main settings" -> Setting for Loadable footer section.
![New onboarding wizard to help you get started.](.wordpress-org/screenshot-17.png)
