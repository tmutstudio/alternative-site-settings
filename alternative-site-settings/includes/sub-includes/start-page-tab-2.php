...
settings_fields( 'altss_settings_options_txt' ); 
                        ...
                        <div class="site-settings-tab-header-div"><?php echo wp_kses(
                            __( 'Text blocks for inserting into a template via the <strong>altss_insertable_text_block( $num, $class )</strong> function:', 'alternative-site-settings' ),
                            [ 'strong' => [] ]
                        ); 
                         ?>
                         </div>
                        <div class="site-settings-template-item-wrapp">
                            <dl>
                                <?php for( $i = 1; $i < 6; $i++ ){?>
                                <dt><p class="site-settings-item-title"><?php echo esc_html__( "Contents of text block No. ", "alternative-site-settings" ) . ' ' . $i; ?></p></dt>
                                <dd>
