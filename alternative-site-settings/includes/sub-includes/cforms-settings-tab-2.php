...
if (current_user_can('manage_options')) {
    ...
    foreach ($FORM_FIELDS as $key => $val) {
        ...
        ?>
            <div class="cf-fields-item">
                <dl>
                    <dt><?php esc_html_e( "Field", "alternative-site-settings" ); ?>: <span><?php echo esc_html( $val['label'] ); ?></span></dt>
                    <dd>
                        <label><strong><?php esc_html_e( "Field label", "alternative-site-settings" ); ?>:</strong></label>
                    ...
                    <dd>
                        <label><?php echo wp_kses( __( "<strong>Placeholder</strong>", "alternative-site-settings" ), $allowed_strong_html ); ?>:</label>
    ...
    ?>
    <div class="">
        <span id="fields-reset"><?php esc_html_e( "Reset fields", "alternative-site-settings" ); ?></span>
    </div>
                <?php
}
else {
    ?>
    <div class="">
        <?php esc_html_e( "This tab is intended for the site administrator!", "alternative-site-settings" ); ?>
    </div>
    <?php
}
