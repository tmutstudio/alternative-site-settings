...
include ALTSITESET_INCLUDES_DIR.'/data-vars/custom-type-vars.php';
                        ...
                        ?>
                        <div class="site-settings-tab-header-div"><?php esc_html_e( "Activation/deactivation of custom records:", "alternative-site-settings" ); ?></div>
                        <div class="site-settings-template-item-wrapp">
                            ...
                            <span style="color: darkred;"><?php esc_html_e( "Important", "alternative-site-settings" ); ?>!</span> <?php esc_html_e( "After connecting or disconnecting a custom post type, you must go to the page:", "alternative-site-settings" ); ?><br>
                            ...
                            <?php esc_html_e( "This is necessary so that the Permalinks rules are recreated and the rules of the new record type are added there.", "alternative-site-settings" ); ?>
                            </div>
                            <dl class="site-settings-custom-recs-dl">
                                <?php
                                foreach ( $CUSTOM_TYPES as $key => $val ) {
                                    ?>
                                <dt><?php echo esc_html__( "Custom records", "alternative-site-settings" ); ?> <span>«<?php echo esc_html( $val['label'] ); ?> (<?php echo esc_html( $key ); ?>)»</span></dt>
                                <dd>
                                    <p>
                                        <?php esc_html_e( "The archive will be available at the link:", "alternative-site-settings" ); ?>
                                    ...
                                    <div class="onoffswitch-over">
                                        ...
                                        <label class="onoffswitch-label-text" for="altss_settings_options_custom_recs_<?php echo esc_attr( $key ); ?>">-  <?php esc_html_e( "check the box to activate this post type", "alternative-site-settings" ); ?></label>
                                    </div>
                                    <div class="onoffswitch-over">
                                        <div class="onoffswitch-left">
                                        ...
                                        <label class="onoffswitch-label-text" for="altss_settings_options_custom_recaltss_settings_<?php echo esc_attr( $key ); ?>_ggeditor">-  <?php esc_html_e( "activate Gutenberg for this post type", "alternative-site-settings" ); ?></label>
                                    </div>
                                    <div class="onoffswitch-over">
                                        <div class="onoffswitch-left">
                                        ...
                                        <label class="onoffswitch-label-text" for="altss_settings_options_custom_recaltss_settings_<?php echo esc_attr( $key ); ?>_nocomments">-  <?php esc_html_e( "disable comments for this post type", "alternative-site-settings" ); ?></label>
                                    </div>
                                </dd>
                                <?php
                                }
